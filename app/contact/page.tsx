              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Contact us by phone</p>
                    <p className="text-sm text-gray-600 mt-1">Call us directly for immediate assistance</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:cixad14507@duoley.com" className="text-blue-600 hover:underline">
                      cixad14507@duoley.com
                    </a>
